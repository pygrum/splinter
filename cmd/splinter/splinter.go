...
var (
	...
	targets     = app.Flag("targets", "string types to extract {[u]rl ipv[4] [r]egistry [k]ey [p]ath [f]ile [e]mail [n]one [a]ll} (comma-separated). 'none' extracts any printable characters (like 'strings')").Short('t').Default("all").String()
